...
-- DATAGO_SEOUL_2022.RSTR_INFO_KOREAN_10000_cohere.embed-v4.0.csv 파일에서 vector_description 칼럼은
-- 이미, OCI GenAI상의 cohere.embed-v4.0 모델을 통해 이미 임베딩된 값이 포함되어 있습니다.
...
LOAD rstr_info DATAGO_SEOUL_2022.RSTR_INFO_KOREAN_10000_cohere.embed-v4.0.csv show;
LOAD rstr_info DATAGO_SEOUL_2022.RSTR_INFO_KOREAN_10000_cohere.embed-v4.0.csv;
